...
void parse_conf_file()
{
	...
	while (fgets(line, 1024, conf) != NULL)
	{
		...
		//	*env << "original url:[" << rtspStreamURL << "]\t proxiedStreamURL:[" << proxiedStreamURLSuffix<< "]\n";
...
int main(int argc, char** argv) {
	...
	*env << "LIVE555 Proxy Server\n"
	...
	// "ProxyServer",
	// "-v",
	// "rtsp://220.178.65.131:554/hikvision://218.23.62.231:8000:0:1?username=admin&password=12345"
	//};
	//argv = args;
	//argc = 3;
